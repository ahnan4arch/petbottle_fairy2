...
#ifndef rge_sample_OpenGLTexture_h
#define rge_sample_OpenGLTexture_h
...
public:
    ...
    void updateRGBA(const cv::Mat& img) {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, img.size().width, img.size().height, 0,GL_RGBA, GL_UNSIGNED_BYTE, img.ptr<void>());
    }
